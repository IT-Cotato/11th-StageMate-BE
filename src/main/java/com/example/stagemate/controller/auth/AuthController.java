...
public class AuthController {
    ...
    public ResponseEntity<DataResponse<String>> signUpInfo(@Valid @RequestBody RegisterUserRequestDTO request) {
    ...
    public ResponseEntity<DataResponse<String>> signUpAgree(@Valid @RequestBody ConsentRequestDTO request) {
        String userId = request.getUserId();
        if (userId == null) {
            throw new AppException(CommonErrorCode.INVALID_PARAMETER, "userId가 필요합니다.");
        }
